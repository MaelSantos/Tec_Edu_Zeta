...
class AlunoService:
    ...
    def save_aluno(self, aluno_data: AlunoCreate) -> Aluno:
        ...
        aluno_id = self.repo.create(novo)
        return self.repo.get_by_id(Aluno, aluno_id)
    ...
    def update_aluno(self, aluno_id: int, aluno_update: AlunoUpdate) -> Optional[Aluno]:
        ...
        aluno = self.repo.get_by_id(Aluno, aluno_id)
        if not aluno:
            return None
